...
- (MKMapRect)_mapRect;
- (void)_cleanClusters:(nonnull NSMutableArray<ADMapCluster *> *)clusters fromAncestorsOfClusters:(nonnull NSArray<ADMapCluster *> *)referenceClusters;
- (void)_cleanClusters:(nonnull NSMutableArray<ADMapCluster *> *)clusters outsideMapRect:(MKMapRect)mapRect;
@end

@implementation ADMapCluster

- (nonnull instancetype)initWithAnnotations:(nullable NSArray *)annotations atDepth:(NSInteger)depth inMapRect:(MKMapRect)mapRect gamma:(double)gamma clusterTitle:(nullable NSString *)clusterTitle showSubtitle:(BOOL)showSubtitle {
    self = [super init];
...
+ (nonnull ADMapCluster *)rootClusterForAnnotations:(nonnull NSArray<ADMapPointAnnotation *> *)initialAnnotations gamma:(double)gamma clusterTitle:(NSString *)clusterTitle showSubtitle:(BOOL)showSubtitle {
    // KDTree
...
- (nonnull NSArray<ADMapCluster *> *)find:(NSInteger)N childrenInMapRect:(MKMapRect)mapRect {
    ...
    NSMutableArray<ADMapCluster *> *_Nonnull clusters = [[NSMutableArray alloc] initWithObjects:self, nil];
    NSMutableArray<ADMapCluster *> *_Nonnull annotations = [[NSMutableArray alloc] init];
    NSMutableArray<ADMapCluster *> *_Nonnull previousLevelClusters = [NSMutableArray array];
    NSMutableArray<ADMapCluster *> *_Nonnull previousLevelAnnotations = [NSMutableArray array];
    ...
    while (clusters.count + annotations.count < N && clusters.count > 0 && clustersDidChange) {
        ...
        NSMutableArray<ADMapCluster *> *_Nonnull nextLevelClusters = [[NSMutableArray alloc] init];
...
- (nonnull NSArray<ADMapCluster *> *)children {
    NSMutableArray<ADMapCluster *> * children = [[NSMutableArray alloc] initWithCapacity:2];
    if (_leftChild != nil) {
...
- (nonnull NSMutableArray<id<MKAnnotation>> *)originalAnnotations {
