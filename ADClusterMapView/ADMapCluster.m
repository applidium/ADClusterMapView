...
- (MKMapRect)_mapRect;
- (void)_cleanClusters:(NSMutableArray<ADMapCluster *> *)clusters fromAncestorsOfClusters:(NSArray<ADMapCluster *> *)referenceClusters;
- (void)_cleanClusters:(NSMutableArray<ADMapCluster *> *)clusters outsideMapRect:(MKMapRect)mapRect;
@end

@implementation ADMapCluster

- (instancetype)initWithAnnotations:(NSArray<ADMapPointAnnotation *> *)annotations
...
+ (ADMapCluster *)rootClusterForAnnotations:(NSArray<ADMapPointAnnotation *> *)annotations
                                      gamma:(double)gamma
                               clusterTitle:(NSString *)clusterTitle
                               showSubtitle:(BOOL)showSubtitle {
    // KDTree
    ...
    ADMapCluster * cluster = [[ADMapCluster alloc] initWithAnnotations:annotations
                                                               atDepth:0
...
- (NSArray<ADMapCluster *> *)find:(NSInteger)N childrenInMapRect:(MKMapRect)mapRect {
    ...
    NSMutableArray<ADMapCluster *> * clusters = [[NSMutableArray alloc] initWithObjects:self, nil];
    NSMutableArray<ADMapCluster *> * annotations = [[NSMutableArray alloc] init];
    NSMutableArray<ADMapCluster *> * previousLevelClusters = [NSMutableArray array];
    NSMutableArray<ADMapCluster *> * previousLevelAnnotations = [NSMutableArray array];
    ...
    while (clusters.count + annotations.count < N && clusters.count > 0 && clustersDidChange) {
        ...
        NSMutableArray<ADMapCluster *> * nextLevelClusters = [[NSMutableArray alloc] init];
