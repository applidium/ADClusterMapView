...
+ (nonnull ADMapCluster *)rootClusterForAnnotations:(nonnull NSArray<ADMapPointAnnotation *> *)annotations gamma:(double)gamma clusterTitle:(nullable NSString *)clusterTitle showSubtitle:(BOOL)showSubtitle;
