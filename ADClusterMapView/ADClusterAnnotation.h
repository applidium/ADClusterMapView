...
typedef NS_ENUM(NSInteger, ADClusterAnnotationType) {
...
@property (nonatomic, weak, nullable) ADMapCluster * cluster;
@property (nonatomic) BOOL shouldBeRemovedAfterAnimation;
@property (weak, nonatomic, readonly, nullable) NSArray<id<MKAnnotation>> * originalAnnotations; // this array contains the annotations contained by the cluster of this annotation
